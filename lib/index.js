(function () {
	...
	var bindAdminRoutes = function(app, models){
		...
		for (i in models)
		{
			...
			var model = {
				name: modelName,
				route: acre.routes[modelName].rootResource,
				module: {
					name: modelName,
			...
			app.get(routePath, getRoute(viewPath, 'text/javascript', {model: model, instance: acre.defaultInstances[modelName]}));
		...
		routePath = acre.options.adminRoute + "/admin-module.js";
		viewPath = __dirname + '/portal/views/admin-module.ejs';
