(function () {
	...
	var bindAdminRoutes = function(app, models){
		...
		app.get(acre.options.adminRoute + '/css/acre.css', function(request, response){
			response.sendfile(__dirname + '/portal/public/css/acre.css');
		});
		cssPaths.push(acre.options.adminRoute + '/css/acre.css');
		...
		app.get(acre.options.adminRoute + '/js/ng-form-direct.js', function(request, response){
			response.sendfile(__dirname + '/portal/public/js/ng-form-direct.js');
		});
		jsPaths.push(acre.options.adminRoute + '/js/ng-form-direct.js');

		app.get(acre.options.adminRoute + '/js/ng-object-view.js', function(request, response){
			response.sendfile(__dirname + '/portal/public/js/ng-object-view.js');
		});
		jsPaths.push(acre.options.adminRoute + '/js/ng-object-view.js');

		app.get(acre.options.adminRoute + '/js/inflect.min.js', function(request, response){
			response.sendfile(__dirname + '/portal/public/js/inflect.min.js');
		});
		jsPaths.push(acre.options.adminRoute + '/js/inflect.min.js');

		app.get(acre.options.adminRoute + '/js/controllers.js', function(request, response){
			response.sendfile(__dirname + '/portal/public/js/controllers.js');
		});
		jsPaths.push(acre.options.adminRoute + '/js/controllers.js');

		app.get(acre.options.adminRoute + '/js/controller-utils.js', function(request, response){
			response.sendfile(__dirname + '/portal/public/js/controller-utils.js');
		});
		jsPaths.push(acre.options.adminRoute + '/js/controller-utils.js');
		...
		app.get(routePath, getRoute(viewPath, 'text/html', {
								models: _models,
								js: jsPaths,
								css: cssPaths,
