(function () {
	...
	var bindAdminRoutes = function(app, models){
		...
		for (i in models)
		{
			...
			var createRoutePath = acre.options.adminRoute + "/" + modelName.toLowerCase() + "-create.html";
			var retrieveRoutePath = acre.options.adminRoute + "/" + modelName.toLowerCase() + "-retrieve.html";
			var updateRoutePath = acre.options.adminRoute + "/" + modelName.toLowerCase() + "-update.html";
			var controllersPath = acre.options.adminRoute + "/js/" + modelName.toLowerCase() + "-controllers.js";
