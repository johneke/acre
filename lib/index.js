(function () {
	...
	var bindAdminRoutes = function(app, models){
		...
		viewPath = __dirname + '/portal/views/js/admin-controllers.ejs';
		app.get(routePath, getRoute(viewPath, 'text/javascript', {models: _models}));
		jsPaths.push(routePath);
		...
		app.get(
			routePath, 
			express.basicAuth(acre.options.adminUserName, acre.options.adminPassword), 
			getRoute(viewPath, 'text/html', {
				models: _models,
				js: jsPaths,
				css: cssPaths,
